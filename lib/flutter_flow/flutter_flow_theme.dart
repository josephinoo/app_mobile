...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFEB447);
  late Color secondary = const Color(0xFF1594CF);
  late Color tertiary = const Color(0xFFEC8FDD);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFE18702);
  ...
  late Color lightPrimary = Color(0xFFFFC36A);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color lightPrimary = Color(0xFF80DEC1);
  late Color primaryBtnText = Color(0xFFFFFFFF);
